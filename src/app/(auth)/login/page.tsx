        ...
        {!isFirebaseConfigured ? (
            <div className="space-y-4">
                 <Alert>
                    ...
                    <AlertDescription>
                        Firebase is not configured. You can continue as a guest to explore the AI features. Some functionality like saving to your library will be disabled.
                    </AlertDescription>
                </Alert>
                <Button onClick={() => setGuestMode(true)} className="w-full">
                    Continue as Guest
                </Button>
            </div>
        ) : (
